...
<!-- Navigation -->
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0; background-color: #1e3883;">
            <div class="navbar-header">
			<img src="../p/oscormart.png" style="height:50px; left:20px; width:50px;  position:fixed;">
			<a href="<?php if($_SESSION['access'] == 1 ){ echo  "../admin/index.php";}?>" class="navbar-brand" style=" margin-left:60px; color:#fdb813;">E.C. Drugmart</a>
            </div>
