<?php
	...
	mysqli_query($conn,"insert into product (product_name,exp_date,categoryid,product_price,product_qty,photo, supplierid) values ('$name','$exp', '$category','$price','$qty','$location', '$supplier')");
